        ...
        <div id="hps_customerBirthdate" style="margin-top: 10px">
            <div>
                ...
                {if isset($birthdate_hps) && $birthdate_hps != '0000-00-00'}
                    {html_select_date|utf8_encode prefix='DateSanHps_' time=$birthdate_hps start_year='-10' end_year='-100' reverse_years='true' day_value_format='%02d' field_order='DMY'}
                {else}
                    {html_select_date|utf8_encode prefix='DateSanHps_' time=$payment_data start_year='-10' end_year='-100' reverse_years='true' day_value_format='%02d' field_order='DMY' all_empty="bitte angeben"}
                {/if}
