{block name="hp_payment_eps"}
	<div class="{$grid} {$classname}" style='background-color: transparent;'>
		<div class="newreg_{$pm}" {if {$hasReg{$pm}}} style="display: none;" {/if}>			
			...
			<label>{s name='hp_eps_BankHolder' namespace='frontend/register/hp_payment'}{/s}*:</label><br />
			...
			<label>{s name='hp_eps_bankBrand' namespace='frontend/register/hp_payment'}{/s}*:</label><br />
