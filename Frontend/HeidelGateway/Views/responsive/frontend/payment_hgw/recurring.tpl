...
<div class="actions">
		<a class="btn is--secondary left" href="{url controller=checkout action=cart}" title="{s name='basket' namespace='frontend/payment_heidelpay/fail'}{/s}">
			{s name='basket' namespace='frontend/payment_heidelpay/fail'}{/s}
		</a>	
        <a class="btn is--primary register--submit right" href="{url controller=account action=payment sTarget=checkout sChange=1}" title="{s name=PaymentLinkChange namespace='frontend/payment_heidelpay/recurring'}{/s}">
