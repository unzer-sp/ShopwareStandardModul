...
<div>
<h2><img align="left" vspace="30" hspace="10" alt="Warnung" src="{link file='frontend/payment_hgw/img/success.png'}" style=" height: 50px; width: 50px;">
...
<div class="actions">
	...
	<br />
	<br />
	<a class="btn is--primary register--submit right" href="{url controller=checkout action=finish sUniqueID=$transID}" title="{s name='OrderOverview' namespace='frontend/payment_heidelpay/prepayment'}{/s}">
