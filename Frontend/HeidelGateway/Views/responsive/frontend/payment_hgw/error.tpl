...
<div>
<h2><img align="left" vspace="10" hspace="20" alt="Warnung" src="{link file='frontend/payment_hgw/img/exclamation_mark.png' fullPath}" style=" height: 50px; width: 50px;">
...
<div class="actions">
	...
	<br />
	<br />
	<a class="btn is--secondary left" href="{url controller=checkout action=cart}" title="{s name='basket' namespace='frontend/payment_heidelpay/error'}{/s}">
